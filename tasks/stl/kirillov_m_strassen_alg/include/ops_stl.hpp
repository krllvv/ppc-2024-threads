...
namespace kirillov_stl {
class StrassenMatrixMultParallelSTL : public ppc::core::Task {
 public:
  explicit StrassenMatrixMultParallelSTL(std::shared_ptr<ppc::core::TaskData> taskData_) : Task(std::move(taskData_)) {}
